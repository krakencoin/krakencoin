...
// Copyright (c) 2013 krakencoin developers
...
const string strMessageMagic = "krakencoin Signed Message:\n";
...
static const int64 nTargetSpacing = 20; // 20s
...
{
        static const int64 BlocksTargetSpacing = 9; // 30 seconds
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("krakencoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("krakencoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("krakencoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running krakencoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("krakencoinMiner terminated\n");
        throw;
    }
}
